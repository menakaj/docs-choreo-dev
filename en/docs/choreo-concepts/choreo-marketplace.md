...
When you deploy a new minor version of a service already deployed in Choreo, the corresponding service in the Service Catalog automatically updates to reflect the latest version within the same major version.
